<?php
	...
	echo
	"
	<select id=\"assign_sel\" ng-model=\"person_id\"
		ng-init=\"unassigned =" . htmlspecialchars(json_encode($unassigned)) . "\"
		ng-options=\"x.id as x.first_name + x.last_name for x in unassigned\">
	</select>
	";
